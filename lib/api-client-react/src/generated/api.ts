...
return customFetch<AdminAccess>(getVerifyAdminUrl(),
  {
    ...options,
    method: 'POST',
...
export const getVerifyAdminMutationKey = () => ['verifyAdmin'] as const;
...
): UseMutationOptions<Awaited<ReturnType<typeof verifyAdmin>>, TError,VerifyAdminMutationVariables, TContext> => {

const mutationKey = getVerifyAdminMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyAdmin>>, VerifyAdminMutationVariables> = (props) => {
          const {data} = props ?? {};
